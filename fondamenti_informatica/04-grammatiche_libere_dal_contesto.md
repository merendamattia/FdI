...
A questo punto, possiamo eliminare i simboli non generativi. Iniziamo eliminando $A \to ε$, che genera la stringa vuota ma non è raggiungibile dal simbolo iniziale:
```
S -> aA | B
A -> aB
B -> Bd
